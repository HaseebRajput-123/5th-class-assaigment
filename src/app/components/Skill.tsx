...
const Skill = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="flex flex-wrap -m-4 -mt-[5rem]">
      ...
      <div className="p-4 md:w-1/3">9
        <div className="flex rounded-lg h-full  p-8 flex-col">
          <div className="flex items-center mb-3">
            <div className="w-8 h-8 mr-3 inline-flex items-center justify-
            center rounded-full  bg-blue-500 text-white flex-shrink-0">
            <IoCheckmarkDoneCircleSharp className='text-xl font-bold' />
            </div>

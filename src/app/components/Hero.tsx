...
const Hero = () => {
  return (
        ...
        <section className="text-gray-600 body-font bg-gray-150">
...
/>
      ...
      <p className="mb-8 leading-relaxed">
        ...
        rerum quod minus suscipit doloribus ipsam, molestiae sint reiciendis,
         magnam nihil voluptas corporis, repellendus perspiciatis error? Odio
          in libero placeat?
      </p>
    ...
    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      <Image
        className="object-cover object-center rounded mx-auto w-[10rem]"
        alt="hero"
        width={500}
        height={500}
